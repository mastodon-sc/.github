...
| [`mastodon-collaborative`](https://github.com/mastodon-sc/mastodon-collaborative)         | A suite of Mastodon plugins originally developed to foster collaborative distributed tracking, including a counterpart [collaborative server](https://github.com/mastodon-sc/mastodon-collaborative/blob/master/SERVER.md). | VU                  | Download from repo.                                                                 |
